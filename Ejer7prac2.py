...
for i in range(len(nombres)):
    alumnos[nombres[i]]=int (notas1[i]) + int (notas2[i]) #se suman las 2 notas y se guarda en el diccionario
print(alumnos) #Muestra el diccionario 
suma=0
i=0
valores=alumnos.values()
for i in valores:   #Sumo todos los valores para después sacar el promedio
    suma=suma + i
